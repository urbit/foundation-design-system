import React$2, { useState, useEffect, useRef, Component } from 'react';
...
const TableOfContents = ({
  ...
  return /*#__PURE__*/React$2.createElement("nav", {
  ...
  }, /*#__PURE__*/React$2.createElement(Headings, {
...
const Headings = ({
...
}, headings.map((heading, index) => /*#__PURE__*/React$2.createElement("li", {
  key: heading.id
}, /*#__PURE__*/React$2.createElement("a", {
  className: classNames({
    "font-bold": index === 0,
  ...
  href: `#${heading.id}`
}, heading.title), heading.items.length > 0 && /*#__PURE__*/React$2.createElement("ul", {
  className: "pl-2 text-xs"
}, heading.items.map(child => /*#__PURE__*/React$2.createElement("li", {
  key: child.id,
...
export { BackgroundImage, Container, Footer, IntraNav, Markdown, Section, SingleColumn, TableOfContents, TwoUp };
